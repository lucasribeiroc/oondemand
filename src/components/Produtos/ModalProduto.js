    ...
    <div className="fixed inset-0 flex items-center justify-center z-50 p-4 md:p-8">
      <div className="w-full max-w-[1266px] h-auto max-h-[calc(100vh-4rem)] overflow-y-auto rounded-2xl border border-[#808e93] bg-[#001E27] text-white">
        <div className="sticky top-0 flex justify-between items-center p-4 border-b border-[#808e93] bg-[#001E27] z-10 rounded-t-2xl">
          <h2 className="text-[16px] md:text-[20px] text-[#F5F5F5] font-montserrat">
            Detalhe do produto
          </h2>
          <button
            onClick={closeModal}
        ...
        <div className="p-4 flex flex-col items-center justify-center">
          <div className="w-full max-w-[1086px] h-auto flex items-center justify-center font-montserrat text-[24px] md:text-[32px] font-medium text-white bg-[#002731] mt-[20px] md:mt-[50px] mb-[20px] md:mb-[50px] rounded-[20px]">
          ...
          <div className="w-full max-w-[1086px] h-auto bg-[#002731] rounded-[20px] flex flex-col items-start justify-start mb-[20px] md:mb-[50px] mx-auto p-4">
            <div className="w-full flex flex-col md:flex-row">
              ...
              <div className="w-full md:w-auto mt-[30px] md:mt-[15px] md:ml-[30px]">
                <span className="block ml-0 md:ml-[50px] font-montserrat text-[24px] md:text-[32px] text-[#f5f5f5]">
                  {modulo.nome}
                </span>
                <div className="ml-0 md:ml-[50px] mt-[20px]">
                  <span className="font-inter text-[16px] md:text-[18px] text-[#f5f5f5]">
                    {modulo.descricao}
                  </span>
                </div>
                <div className="mt-[20px]">
                  <span className="block ml-0 md:ml-[50px] font-inter text-[24px] md:text-[30px] text-[#00E2F4] flex gap-2">
                ...
                <div className="mt-[20px] ml-0 md:ml-[50px]">
                  <ul className="font-inter text-[16px] md:text-[18px] font-light text-[#f5f5f5] flex flex-col gap-2 list-disc pl-0">
                ...
                <div className="mt-[20px] ml-0 md:ml-[50px] flex items-start">
                  <div>
                    <div className="font-montserrat font-semibold text-[32px] text-[#00e2f4]">
                      {modulo.ativacao}
                      <span className="font-montserrat font-semibold text-[16px] text-[#00e2f4] ml-5">
                        (custo de ativação)
                      </span>
                    </div>
                    <div className="font-montserrat font-semibold text-[24px] text-[#55787f] mt-2">
                      {modulo.mensalidade}
                      <span className="font-montserrat font-semibold text-[16px] text-[#55787f] ml-2">
            ...
            <div className="w-full mt-4 ml-8 flex items-center">
              ...
              <div className="flex flex-col items-start ml-0">
                <span className="font-inter font-medium text-[16px] text-[#f5f5f5] mb-0">
                  Este módulo poupou
                </span>
                <div className="font-inter font-bold text-[22px] text-[#f5f5f5]">
              ...
              <div className="flex flex-col items-start ml-1">
                <span className="font-inter font-medium text-[16px] text-[#f5f5f5] ml-0 mb-0">
                  Este módulo poupou
                </span>
                <div className="font-inter font-bold text-[22px] text-[#f5f5f5] ml-0">
                  {modulo.valorPoupado}
                </div>
              </div>
            </div>
