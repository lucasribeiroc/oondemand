...
const TestemunhoModulo = ({ testemunho }) => {
  return (
    <div className="flex justify-center items-center h-full w-full">
      <div className="w-[303px] h-[400px] bg-white rounded-[10px] shadow-lg box-border flex flex-col justify-between relative">
        <div className="w-[303px] h-[292px] bg-[#00E2F4] p-4 flex items-center justify-center rounded-t-[10px] relative">
          ...
          <div className="w-[241px] h-[200px] flex items-center justify-center pl-5 mt-[-20px]">
            <p className="text-[12px] font-montserrat text-[#2E363E] leading-[1.8] font-bold">
